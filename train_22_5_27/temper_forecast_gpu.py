...
if __name__ == "__main__":
    ...
    # using sklearn.model_selection.traing_test_split
    df = pd.read_csv('data.csv')
    X = df.drop(columns=['date','new_cases','new_deaths','stringency_index'])
    print(X.shape)
    y = df['new_cases']
    ...
    val_loader = Data.DataLoader(dataset=val_data, batch_size=BATCH_SIZE, shuffle=False, drop_last=True)
